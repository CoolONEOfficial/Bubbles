...
void Widget::paintEvent(QPaintEvent *)
{
    ...
    p.drawText(QRect(0, 0, width(), p.font().pixelSize()), Qt::AlignRight, "Bubbles v0.2.2");
...
void Widget::loadAll()
{
    ...
    {
        backgrounds[f].load(baseDir+"\\images\\background"+QString::number(f+1)+".jpg");
    }

    bubbleImg.load(baseDir+"\\images\\bubble.png");

    siteFont.setFamily(QFontDatabase::applicationFontFamilies( QFontDatabase::addApplicationFont(baseDir+"//fonts//arista//arista.ttf")).first() );
